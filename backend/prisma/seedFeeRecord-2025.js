 ...
 * ===================================================== */
async function main() {
  console.log("🚀 Seed FeeRecord 2025 – FINAL FULL")
  ...
  for (const fee of feeTypes) {
    ...
    if (fee.isMandatory) {
      for (const h of households) {
        ...
        if (r <= 87) {
          ...
          // Đóng một phần
          const amt = Math.floor(expected * rand(40, 70) / 100)
    ...
    for (const h of households) {
      ...
      const amount = rand(20000, 250000)
  ...
  console.log("✅ Seed FeeRecord 2025 hoàn tất")
